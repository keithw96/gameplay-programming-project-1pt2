...
{
	// Front Face
	0.00f, 0.00f,  1.00f,	// [0]	// ( 0)
	 1.00f, 0.00f,  1.00f,	// [1]	// ( 1)
	 1.00f,  1.00f,  1.00f,	// [2]	// ( 2)
	0.00f,  1.00f,  1.00f,	// [3]	// ( 3)

	// Top Face
	0.00f,  1.00f,  1.00f,	// [3]	// ( 4)
	 1.00f,  1.00f,  1.00f,	// [2]	// ( 5)
	 1.00f,  1.00f, 0.00f,	// [6]	// ( 6)
	0.00f,  1.00f, 0.00f,	// [7]	// ( 7)

	// Back Face
	 1.00f, -1.00f, 0.00f,	// [5]	// ( 8)
	0.00f, -1.00f, 0.00f, // [4]	// ( 9)
	0.00f,  1.00f, 0.00f,	// [7]	// (10)
	 1.00f,  1.00f, 0.00f,	// [6]	// (11)

	// Bottom Face
	0.00f, 0.00f, 0.00f, // [4]	// (12)
	 1.00f, 0.00f, 0.00f, // [5]	// (13)
	 1.00f, 0.00f,  1.00f, // [1]	// (14)
	0.00f, 0.00f,  1.00f, // [0]	// (15)

	// Left Face
	0.00f, 0.00f, 0.00f, // [4]	// (16)
	0.00f, 0.00f,  1.00f, // [0]	// (17)
	0.00f,  1.00f,  1.00f, // [3]	// (18)
	0.00f,  1.00f, 0.00f, // [7]	// (19)

	// Right Face
	 1.00f, 0.00f,  1.00f, // [1]	// (20)
	 1.00f, 0.00f, 0.00f, // [5]	// (21)
	 1.00f,  1.00f, 0.00f, // [6]	// (22)
